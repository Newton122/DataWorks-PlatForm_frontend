          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--text-muted)]">contact@dataworks.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--text-muted)]">San Francisco, CA</p>
                  </div>
                </div>
            ...
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg p-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-[var(--border-color)] rounded-lg flex items-center justify-center hover:bg-[var(--accent-primary)] transition-colors">
